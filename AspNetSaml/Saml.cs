...
namespace Saml
{
    public abstract class BaseResponse
    {
        ...
        protected bool ValidateSignatureReference(SignedXml signedXml)
        {
            ...
            if (!string.IsNullOrEmpty(reference?.Uri)) //Reference URI=""�̏ꍇ��root�v�f�ւ̎Q�Ƃƌ��Ȃ�
            {
    ...
    public class Response : BaseResponse
    {
        ...
        public virtual string GetEmail()
        {
            return GetCustomAttribute("User.email")
                ...
                ?? GetCustomAttribute("email"); //some providers put last name into an attribute named "mail"
        }
    ...
    public class AuthRequest : BaseRequest
    {
        ...
        /// <param name="issuer">put your EntityID here</param>
        /// <param name="assertionConsumerServiceUrl">put your return URL here</param>
        /// <param name="destination">put your destination here</param>
        public AuthRequest(string issuer, string assertionConsumerServiceUrl, string destination) : this(issuer, assertionConsumerServiceUrl)
        {
